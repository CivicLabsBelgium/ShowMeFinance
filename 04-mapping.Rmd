...
Posterior to the mapping job, [the original CSV file from the SI list has been uploaded and cleaned in RStudio](#importing).
...
[Click here for more information on the metadata in the response](#understanding)
