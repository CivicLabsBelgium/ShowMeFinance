---
title: "Show Me Finance : Mapping European financial data to the OpenFIGI API "
author: "A **CivicLabs Belgium** project by : Antoine Kopij, Bert Jehoul, Ron,... (we welcome all contributions, feel free to add your name to the author list). Read more on the [Show Me Finance blog](https://medium.com/show-me-finance) and twitter: [@ShowMeFin](https://twitter.com/ShowMeFin). Contact: ShowMeFin-at-gmail-dot-com, or meet us in person at the [Civic labs meetups](https://www.meetup.com/Civic-Lab-Brussels) "
site: bookdown::bookdown_site
documentclass: book
github-repo: CivicLabsBelgium/ShowMeFinance
url: 'https\://showmefinance.org'
---
...
Follow this link for [detailed information and methods](#understanding) to combine both sources. 

### Buildings functions for a package {-}

- [Importing the ESMA data into R](#importing)
- [Mapping of an Italian bond with OpenFIGI using R](#mapping)
